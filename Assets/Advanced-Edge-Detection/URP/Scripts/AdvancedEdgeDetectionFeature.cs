...
namespace INab.AdvancedEdgeDetection.URP
{
	...
	public class AdvancedEdgeDetectionFeature : ScriptableRendererFeature
	{
		...
		public class EdgeDetectionPass : ScriptableRenderPass
		{
			...
			private RenderTargetHandle m_EdgeRT; 
			...
			public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
			{
				...
				opaqueDesc.colorFormat = RenderTextureFormat.RHalf;
				cmd.GetTemporaryRT(m_EdgeRT.id, opaqueDesc, FilterMode.Point);


				Blit(cmd, source, m_EdgeRT.Identifier(), m_EdgeDetection, 0);
				Blit(cmd, source, m_TemporaryColorTexture.Identifier(), m_EdgeBlend, 0);
			...
			public override void FrameCleanup(CommandBuffer cmd)
			{
				...
				cmd.ReleaseTemporaryRT(m_EdgeRT.id);
			}
		}
	}
}